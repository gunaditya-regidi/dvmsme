            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <a href="mailto:talentcomputers2013@gmail.com" className="text-xl font-semibold hover:text-gray-200 transition block break-all">
                      talentcomputers2013@gmail.com
                    </a>
