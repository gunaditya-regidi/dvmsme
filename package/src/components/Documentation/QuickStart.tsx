    ...
    return (
        <div className="pb-10 md:scroll-m-[180px] scroll-m-28" id="start" >
          ...
          <div className="p-6 rounded-md border mt-6 border-border dark:border-dark_border">
             ...
             <p className="text-base font-medium text-midnight_text dark:text-white/50">Before proceeding, you need to have the latest stable <a href="https://nodejs.org/" className="text-primary" >node.js</a> </p>
          ...
          <div className="p-6 rounded-md border mt-6 border-border dark:border-dark_border">
             ...
             <p className="text-base font-medium text-midnight_text dark:text-white/50">Open package folder and install its dependencies. We recommanded yarn or npm. </p>
          ...
          <div className="p-6 rounded-md border mt-6 border-border dark:border-dark_border">
             ...
             <p className="text-base font-medium text-midnight_text dark:text-white/50 mb-4">Once npm install is done now you an run the app.</p>

              <div className="py-4 px-3 rounded-md bg-black">
                <p className="text-sm text-gray-400">npm run dev or yarn run dev</p>
              </div>
              <p className="text-base font-medium text-midnight_text dark:text-white/50 my-4">This command will start a local webserver <span className="dark:text-white" >http://localhost:3000:</span></p>
              <div className="py-4 px-3 rounded-md bg-black">
                <p className="text-sm text-gray-400">{"> digital_videos_msme@1.0.1 dev"}</p>
          ...
          <div className="p-6 rounded-md border mt-6 border-border dark:border-dark_border">
             ...
             <p className="text-base font-medium text-midnight_text dark:text-white/50 mb-4">After adding url run below command for build a app.</p>

              <div className="py-4 px-3 rounded-md bg-black">
                <p className="text-sm text-gray-400">npm run build or yarn build</p>
              </div>
              <p className="text-base font-medium text-midnight_text dark:text-white/50 mt-6">Finally, Your webiste is ready to be deployed.🥳</p>
          </div>
        </div>
    )
}