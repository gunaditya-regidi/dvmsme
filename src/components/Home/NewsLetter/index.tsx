                    ...
                    <div className="" data-aos="fade-left">
                        <div className="mb-8">
                            ...
                            <h2 className="text-3xl font-medium mb-6">
                                Stay informed about new and upcoming services
                            </h2>
                            <p className="text-base text-muted dark:text-white/60">
                            Subscribe to our updates and stay connected with the latest services and initiatives. Be among the first to learn how you can make a difference in urgent and upcoming projects!
                            </p>
                        </div>
                        <form>
                            <div className="mb-6">
