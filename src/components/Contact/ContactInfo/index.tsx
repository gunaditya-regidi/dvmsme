      ...
      <section className="dark:bg-dark pt-8 lg:pb-24 pb-16">
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  ...
                  <p className="text-DeepOcean font-normal max-w-80 pt-3 pb-7 dark:text-white/50 text-base">
                    For any queries, collaborations, or partnerships, <br />please reach out using the contact link below or connect with us directly using the contact details provided.
                  </p>
                </div>
                <div>
                  <Link href="mailto:talentcomputers2013@gmail.com" className="text-primary text-base font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white">
                    Leave a message
                    <svg
                      width="23"
                      height="17"
            ...
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  ...
                  <p className="text-DeepOcean font-normal max-w-80 pt-3 pb-7 dark:text-white/50 text-base">
                    Looking to build your career with us? <br /> <br />
                    Send your resume by clicking the link below. <br />Our team will get in touch if your profile matches our current openings.
                  </p>
                </div>
                <div>
                  <Link href="mailto:hr1@digitalvideosmsme.com" className="text-primary text-base font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white">
                    Send an application
                    <svg
                      width="23"
                      height="17"
          ...
          <div className="md:pt-32 pt-11 md:pb-28 pb-8">
            <iframe src="https://www.google.com/maps/embed/v1/search?key=AIzaSyD1VnYC6EugmolDY9RjsZ77TeXstyj0288&q=17.743809,+83.331287" width="1114" height="477" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-lg w-full"></iframe>
          </div>
        </div>
